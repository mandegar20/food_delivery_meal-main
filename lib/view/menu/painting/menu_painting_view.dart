...
class MenuPaintingView extends StatefulWidget {
  final Map mObj;
  const MenuPaintingView({super.key, required this.mObj});

  @override
  State<MenuPaintingView> createState() => _MenuItemsViewState();
}

class _MenuItemsViewState extends State<MenuPaintingView> {
