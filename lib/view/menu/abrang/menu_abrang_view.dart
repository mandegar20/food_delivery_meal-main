...
class MenuAbrangView extends StatefulWidget {
  final Map mObj;
  const MenuAbrangView({super.key, required this.mObj});

  @override
  State<MenuAbrangView> createState() => _MenuItemsViewState();
}

class _MenuItemsViewState extends State<MenuAbrangView> {
